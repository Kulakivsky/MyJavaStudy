...
public class View {
    ...
    public static final String INPUT_NUMBER_LOWER_THAN_BORDER = "Number from input is lower than min border";
    public static final String INPUT_NUMBER_BIGGER_THAN_BORDER = "Number from input is bigger than max border";
    ...
    public void printMessageUserGetRightNumber(ArrayList usersTries, int getMinNumber, int getMaxNumber) {
